export const dict = {
  ...
  "settings.general.row.efficientMode.title": "Tryb oszczędny",
  "settings.general.row.efficientMode.description":
    "Wyłącza animacje i płynne przewijanie, aby zmniejszyć zużycie zasobów.",
  "settings.general.row.efficientMode.off": "Wyłączony",
  "settings.general.row.efficientMode.always": "Zawsze",
  "settings.general.row.efficientMode.unfocused": "Gdy okno nie jest aktywne",
