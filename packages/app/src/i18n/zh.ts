...
export const dict = {
  ...
  "settings.general.row.efficientMode.description": "禁用动画和平滑滚动，以减少资源占用。",
  "settings.general.row.efficientMode.off": "关闭",
  "settings.general.row.efficientMode.always": "始终",
  "settings.general.row.efficientMode.unfocused": "窗口未聚焦时",
